...
function update_graphs() {
    if (isConnected === 1){
        ...
        intensity_arr_1.push(new Circle(w/2 - 175, small_read_arr[13] + h/2 - intensity_floor_value, intensity_arr_1));
        intensity_arr_2.push(new Circle(w/2 + 250, small_read_arr[14] + h/2 - intensity_floor_value, intensity_arr_2));
